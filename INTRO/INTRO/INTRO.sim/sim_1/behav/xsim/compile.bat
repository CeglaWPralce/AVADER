...
REM
REM Generated by Vivado on Thu Nov 06 12:50:10 +0100 2025
...
echo "xvlog --incr --relax -prj tb_or_and_tree_vlog.prj"
call xvlog  --incr --relax -prj tb_or_and_tree_vlog.prj -log xvlog.log
